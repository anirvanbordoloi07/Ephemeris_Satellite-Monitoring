...
export default function TermsPage() {
  return (
    <Layout
      title="Terms of Service — Ephemeris"
        ...
        <section className="page-wrap">
          ...
          <div style={{ maxWidth: 720, color: "var(--muted)", lineHeight: 1.8, display: "grid", gap: 20 }}>
            <p>
              ...
              individual agreements. This page will be replaced with full terms of service —
              covering acceptable use, service availability, and liability — before the product is
